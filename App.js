...
constructor(props) {
 ...
 InsertStudentRecordsToServer = () =>{
      ...
      fetch('http://localhost/eyes2sreactdb/InsertStudentData.php', {
      method: 'POST',
      headers: {
...
class ShowStudentListActivity extends Component {
  ...
  componentDidMount() {
       ...
       return fetch('http://localhost/eyes2sreactdb/ShowAllStudentsList.php')
         .then((response) => response.json())
         .then((responseJson) => {
...
class EditStudentRecordActivity extends Component {
  ...
  constructor(props) {
    ...
    UpdateStudentRecord = () =>{
            ...
            fetch('http://localhost/eyes2sreactdb/UpdateStudentRecord.php', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
    ...
    DeleteStudentRecord = () =>{
          ...
          fetch('http://localhost/eyes2sreactdb/DeleteStudentRecord.php', {
          method: 'POST',
          headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
